export default function TermOfService() {
  return (
    <div>
      ...
      <p>
        Thank you for using the <a href='https://tuxihub.com'>Tuxihub.com</a>{' '}
        website and My App application (hereinafter referred to as the “
        <strong>Platform</strong>”). These Terms of Service (hereinafter
        referred to as the “<strong>Terms</strong>”) constitute a legal
        agreement between you (hereinafter referred to as “<strong>User</strong>
        ” or “<strong>You</strong>”) and individual proprietor [Insert Your Name
        Here] (hereinafter referred to as “<strong>We</strong>,” “
      ...
      <h2>6. User Feedback and Suggestions</h2>
      <p>
        If you provide us with feedback, suggestions, ideas, or improvement
        requests regarding the Platform or services (hereinafter referred to as
        “<strong>Feedback</strong>”), you agree that we may freely and without
        compensation, use such Feedback for any purpose, including but not
        limited to improving the Platform and services, developing new features,
        marketing, etc., without any obligation to provide you with compensation
        or attribution.
      </p>
