export default function Privacy() {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to My App.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Oregon, United States
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to My App, accessible from{' '}
            <a
              href='https://tuxihub.com'
      ...
      <p>
        Usage Data may include information such as Your Device&apos; Internet
      ...
      <p>
        ...
        already associated with Your Third-Party Social Media Service&apos;
      ...
      <p>
        ...
        Company through Your Third-Party Social Media Service&apos; account. If
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            such as a mobile application&apos; push notifications regarding
      ...
      <p>
        ...
        require Your parent&apos; consent before We collect and use that
        information.
      </p>
      ...
      <ul>
        <li>By email: wzx1991@gmail.com</li>
      </ul>
    </div>
  );
}
